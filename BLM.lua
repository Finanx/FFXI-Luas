...
function init_gear_sets()
	...
	sets.Marin_Staff = {main="Mage\'s Staff", sub="Khonsu"}
	
	sets.Mpaca = {main={ name="Mpaca's Staff", augments={'Path: A',}}, sub="Khonsu",}
	
	sets.Hvergelmir = {main={ name="Marin Staff +1", augments={'Path: A',}}, sub="Khonsu"}
	
	sets.Laevateinn = {main={ name="Marin Staff +1", augments={'Path: A',}}, sub="Khonsu"}
...
function update_combat_form()
	...
	if state.WeaponSet.value == 'Marin_Staff' then
		enable('main','sub')
		equip(sets.Marin_Staff)
		disable('main','sub')
	end
	...
	if state.WeaponSet.value == 'Hvergelmir' then
		enable('main','sub')
		equip(sets.Hvergelmir)
		disable('main','sub')
	end

	if state.WeaponSet.value == 'Laevateinn' then
		enable('main','sub')
		equip(sets.Laevateinn)
		disable('main','sub')
	end

	if state.WeaponSet.value == 'Opashoro' then
		enable('main','sub')
		equip(sets.Opashoro)
		disable('main','sub')
	end
