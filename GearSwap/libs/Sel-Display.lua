...
function update_job_states()
	...
	local clr = {
		...
		Thunder='\\cs(190,90,190)', -- Purple For Lightning Element
	...
	local labels = {
		...
		SpellInterrupt = "Spell Interrupt",
		TPBonus = "TP Bonus",
		NukeMode = "Nuke Mode",
		Shield = "Shield",
		...
		RangeSet = "Range Weapon",
		Quickdraw = "Quickdraw Element",
		CorsairShot = "Corsair Shot",
		Barspell = "Barspell",
		BarStatus = "Barstatus",
		BoostSpell = "BoostSpell",
		RegenMode = "Regen Mode",
		MagicBurst = "Magic Burst",
		Grip = "Grip",
		AutoCoatMode = "AutoCoatMode",
		ShowPetHP = "ShowPetHP",
	}
	...
	for i,n in ipairs(stateList) do
		...
		elseif n == 'Quickdraw' then
				stateBox:append(string.format("%sElement: %s%s    ", clr.w, clr[state.Quickdraw.value], state.Quickdraw.value))
