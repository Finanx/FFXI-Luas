...
function init_gear_sets()
    ...
    sets.precast.FC.Grimoire = {head="Peda. Mortar. +4", feet="Acad. Loafers +3"}
    ...
    sets.DarkArts = set_combine(sets.midcast['Enfeebling Magic'], {head="Acad. Mortar. +4",body="Acad. Gown +3",})
