...
function init_gear_sets()
	...
	sets.midcast.Curaga_Spell_Interrupt = sets.midcast.Cure_SpellInterrupt
	...
	sets.Daybreak = {main="Lorg Mor", sub="Maxentius",}
	sets.Daybreak.SW = {main="Lorg Mor", sub="Genmei Shield"}
...
function job_post_midcast(spell, action, spellMap, eventArgs)
	...
	if spellMap == 'Curaga' and state.SpellInterrupt.value == true then
		equip(sets.midcast.Cure_SpellInterrupt)
	end
...
function job_get_spell_map(spell, default_spell_map)
    if spell.action_type == 'Magic' then
        ...
        elseif default_spell_map == 'Curaga' and state.SpellInterrupt.value == false then
            if (world.weather_element == 'Light' or world.day_element == 'Light') then
