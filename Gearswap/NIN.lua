...
function user_unload()
	...
	send_command('wait 4;put Shihei all')
	send_command('wait 4;put Inoshishinofuda all')
	send_command('wait 4;put Shikanofuda all')
	send_command('wait 4;put Chonofuda all')
