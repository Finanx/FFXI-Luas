...
function init_gear_sets()
    ...
    sets.precast.JA['Valiance'] = set_combine(sets.Enmity,{body="Runeist Coat +4",legs={ name="Futhark Trousers +4", augments={'Enhances "Inspire" effect',}}})
    ...
    sets.precast.JA['Gambit'] = {hands="Runeist Mitons +4"}
	...
	sets.precast.FC.Enhancing = set_combine(sets.precast.FC, {legs={ name="Futhark Trousers +4", augments={'Enhances "Inspire" effect',}},})
		
	sets.precast.FC.Val = set_combine(sets.precast.FC,{ammo="Staunch Tathlum +1",left_ear="Tuisto Earring",})
	
	sets.precast.FC.ValEnhancing = set_combine(sets.precast.FC, {legs={ name="Futhark Trousers +4", augments={'Enhances "Inspire" effect',}},})
    ...
    sets.midcast['Phalanx'] = {
		...
		ammo="Staunch Tathlum +1",
		head="Fu. Bandeau +4",
		body={ name="Herculean Vest", augments={'STR+14','Attack+3','Phalanx +4','Mag. Acc.+11 "Mag.Atk.Bns."+11',}},
	...
	sets.midcast['Temper'] = {
		...
		body="Runeist Coat +4",
		hands="Rune. Mitons +4",
		legs={ name="Futh. Trousers +4", augments={'Enhances "Inspire" effect',}},
		feet={ name="Carmine Greaves +1", augments={'HP+80','MP+80','Phys. dmg. taken -4',}},
    ...
    sets.Embolden = {back={ name="Evasionist's Cape", augments={'Enmity+3','"Embolden"+15','"Dbl.Atk."+3',}},}
