...
function user_setup()
	...
	--Retrieve Gear for Blue Mage
	
	send_command('wait 3;org get inventory blu.lua')
...
function init_gear_sets()
	...
	sets.precast.WS.FullTPPhysical = {left_ear="Ishvara Earring",right_ear={ name="Hashi. Earring +1", augments={'System: 1 ID: 1676 Val: 0','Accuracy+15','Mag. Acc.+15','"Dbl.Atk."+5',}},}
